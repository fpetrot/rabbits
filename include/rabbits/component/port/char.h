...
#ifndef _RABBITS_COMPONENT_PORT_CHAR_PORT_H
#define _RABBITS_COMPONENT_PORT_CHAR_PORT_H
...
public:
    ...
    CharPort(const std::string & name) : Port(name), m_chardev_cs(tx, rx), tx("tx"), rx("rx")
    {
